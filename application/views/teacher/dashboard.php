        	...
        	<div class="col-12 grid-margin">
              ...
              <div class="card">
                ...
                <?php if($class!=null) { ?>
                  ...
                  <a href="<?php echo base_url(); ?>teacher/teacherhome/view_attendance?id=<?php echo $teacher; ?>">View Attendance</a>
                  <form method="post" action="<?php echo base_url(); ?>teacher/teacherhome/attendance">
                    <table class="table table-striped">
                     ...
                     <?php  foreach ($class as $something):?>
                        <tr>
                          <td><?php echo $something->name; ?></td>
                          <td class="py-1"><?php echo $something->email; ?></td>
                          <td>
                            Present <input type="radio" checked  name="attendance[<?php echo $something->id; ?>]" value="Present">
                            Absent <input type="radio"  name="attendance[<?php echo $something->id; ?>]" value="Absent">
                        </td>
                  ...
                  <input type="submit" class="btn btn-primary btn-md" name="submit" value="Take Attendance">
                  </form>
                </div>
                <?php }else{ ?>
                <span>No existing student records</span>
                <?php } ?>
              </div>
            </div>
          </div>
