                ...
                <div class="card-body">
                  ...
                  <?php echo $message; ?>
                    ...
                    <table class="table table-striped">
                     ...
                     <?php $i=1; foreach ($details as $something):?>
                        <tr>
                          <td><?php echo $i; $i=$i+1;?></td>
                          <td class="py-1"><?php echo $something->date; ?></td>
                          <td>
                            <a href="<?php echo base_url(); ?>teacher/teacherhome/datewiseattendance?id=<?php echo $teacher_id; ?>&date=<?php echo $something->date; ?>">View</a>
                        </td>
