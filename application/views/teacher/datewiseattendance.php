                    ...
                    <table class="table table-striped">
                     ...
                     <?php foreach ($attendance as $row):?>
                        <tr>
                          ...
                          <td class="py-1"><?php echo $row['student']->email; ?></td>
                          <td>
                          <?php if($row['attendanceDetails']->value=='Present'){ ?>
                            Present <input type="radio" name="attendance[<?php echo $row['student']->id; ?>]" value="Present" checked>
                            Absent <input type="radio" name="attendance[<?php echo $row['student']->id; ?>]" value="Absent">
                          <?php }else{ ?>
                            Present <input type="radio" name="attendance[<?php echo $row['student']->id; ?>]" value="Present">
                            Absent <input type="radio" name="attendance[<?php echo $row['student']->id; ?>]" value="Absent" checked>
                          <?php } ?>
