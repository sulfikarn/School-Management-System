        ...
        <div class="content-wrapper">
          <div class="col-12 grid-margin">
            <div class="card">
              ...
              <?php } ?>
                <!-- <h4 class="card-title">Entroll Student -->
                
                
                <form class="form-sample" method="post" action="<?php echo base_url(); ?>index.php/admin/students/register" >
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                          <input class="form-control" name="parent_name" placeholder="Parent name" required/>
                            <?php echo form_error('name'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" name="relation" placeholder="Relation" required/>
                              <?php echo form_error('name'); ?>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                            ...
                            <?php foreach ($class as $list) { ?>
                              <option value="<?php echo $list->class_name; ?>"><?php echo $list->class_name; ?></option>
                              <?php } ?>
                            </select>
                            <?php echo form_error('name'); ?>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                          <input class="form-control" type="date" name="dob" placeholder="dd/mm/yy" required/>
                            <?php echo form_error('name'); ?>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row required">
                          <label class="col-sm-3 col-form-label">Parents phone no</label>
                          <div class="col-sm-9">
                          <input class="form-control" type="number" name="mob" placeholder="0000000000" required/>
                            <?php echo form_error('name'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                            <select required class="form-control" name="bld_grp">
                              <option value="">Select One</option>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input class="form-control" type="text" name="adhar_no" placeholder="0000000000"/>
                            <?php echo form_error('name'); ?>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                          <input class="form-control" type="email" name="email" placeholder="0000000000" required/>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                          <input class="form-control" type="password" name="password" placeholder="0000000000" required/>
                          <?php echo form_error('name'); ?>
                          </div>
                        </div>
                      </div>
     ...
     $.ajax({
       ...
       success:function(data){
         ...
         data['divisions'].forEach(element => {
           $('#division').append('<option value='+element+'>'+element+'</option>')
         });
       },
       error:function(){
