          ...
          <div class="col-12 grid-margin">
            <div class="card">
              ...
              <?php } ?>
                ...
                <form class="form-sample" method="post" action="<?php echo base_url(); ?>index.php/admin/students/parent_register" >
                    <div class="row">
                        <div class="col-md-6" style="display:none">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">studentId</label>
                            <div class="col-sm-9">
                              <input type="text" name="student_id" value="<?php echo $data1->user_id ?>" class="form-control" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="parent_name" class="form-control" value="<?php echo $data1->parent_name; ?>" readonly/>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <textarea name="address" class="form-control" readonly><?php echo $data1->address; ?></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="mob" class="form-control" value="<?php echo $data1->mob; ?>" readonly />
                            </div>
                          </div>
                        </div>
                    </div>
