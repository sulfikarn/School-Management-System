          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <form class="form-sample" method="post" action="<?php echo base_url(); ?>index.php/admin/students/add_classTeacher" >
                    <div class="row">
                    <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <?php foreach ($class as $perreq) { ?>
                                <option value="<?php echo $perreq->class_id; ?>"><?php echo $perreq->class_name; ?></option>
                              <?php } ?>
                              </select>
                            </div>
                          </div>
