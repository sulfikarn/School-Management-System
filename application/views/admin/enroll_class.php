          ...
          <div class="col-12 grid-margin">
            <div class="card">
              ...
              <?php } ?>
                ...
                <form class="form-sample" method="post" action="<?php echo base_url(); ?>index.php/admin/students/add_class" >
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                          <div class="form-group row  required">
                            ...
                            <div class="col-sm-9">
                                <select required name="teacherName" class="form-control" />
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <?php foreach ($class as $perreq) { ?>
                        <tr>
                          
                          <td class="py-1"><?php echo $perreq['login']->name; ?></td>
                          <td><?php echo $perreq['class']->class_name; ?></td>
                          <td><?php echo $perreq['class']->division; ?></td>
                        </tr>
                      <?php } ?>
