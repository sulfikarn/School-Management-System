              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample">
                    ...
                    <div class="row">
						<div class="col-md-2">
                            <div class="form-group row">
                              <label for="exampleFormControlSelect1">Current Batch</label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group row">
                              <label for="exampleFormControlSelect1">New Batch</label>
                                <select class="form-control form-control-lg" id="exampleFormControlSelect1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group row">
                              <label for="exampleFormControlSelect1">From Class</label>
                                <select class="form-control form-control-lg" id="exampleFormControlSelect1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group row">
                              <label for="exampleFormControlSelect1">To Class</label>
                                <select class="form-control form-control-lg" id="exampleFormControlSelect1">
                                  <option>LKG</option>
                                  <option>UKG</option>
                                  <option>STD-1</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group row">
                              <label for="exampleFormControlSelect1">From Division</label>
                                <select class="form-control form-control-lg" id="exampleFormControlSelect1">
                                  <option>A</option>
                                  <option>B</option>
                                  <option>C</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group row">
                              <label for="exampleFormControlSelect1">To Division</label>
                                <select class="form-control form-control-lg" id="exampleFormControlSelect1">
                                  <option>A</option>
                                  <option>B</option>
                                  <option>C</option>
                    ...
                    <div class="col-md-12 ">
                    	<button type="button" class="btn btn-success btn-fw">Promote</button>
                    </div>
